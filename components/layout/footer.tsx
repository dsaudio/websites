...
function Footer(props: LngProps) {
  ...
  return (
    <div className="w-full border-b border-gray-200 py-5 text-center dark:border-gray-700">
      ...
      {/*    href="https://github.com/dsaudio/dsaudio.github.io"*/}
      {/*    target="_blank"*/}
      ...
      <span className="mt-2 flex flex-wrap items-center justify-center text-sm text-gray-500 dark:text-gray-400 sm:text-center">
        ...
        <a href="https://www.kjxbyz.com/dsaudio" className="hover:underline">
          {th("title")}
        </a>
        . {t("copyright")}&nbsp;
        {process.env.VERCEL_GIT_COMMIT_SHA && (
          <p className="flex items-center justify-center">
            <a
              href={`https://github.com/dsaudio/dsaudio.github.io/commit/${process.env.VERCEL_GIT_COMMIT_SHA}`}
              target="_blank"
        ...
        &nbsp;
        <Image
          src="https://visitor-badge.laobi.icu/badge?page_id=dsaudio.kjxbyz.com"
          width={60}
          height={20}
          alt="visitor badge"
        />
